...
if __name__ == "__main__":
    ...
    parser.add_argument('--balanced_bool', action='store_true', help='Boolean flag to balance datasets (default: False)')
    parser.add_argument('--filename_fuse', type=str, default='gene_fusion_ML/dataset/fingerprint_fuse.txt', help='Filename for fuse data')
    parser.add_argument('--filename_no_fuse', type=str, default='gene_fusion_ML/dataset/fingerprint_no_fuse.txt', help='Filename for no fuse data')
    ...
    save_path = 'gene_fusion_ML/models_mge/'  # Change this to your desired folder
