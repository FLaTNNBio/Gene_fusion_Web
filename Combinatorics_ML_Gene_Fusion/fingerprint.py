...
# Create fingerprint files (args.step = 'only_dataset') to generate fingerprint dataset (MML-MGE)#################################################################
def fingerprint_only_on_dataset(args):
    ...
    if args.dictionary == 'yes':
        dictionary_file = open("%s" % args.dictionary_path + "dictionary_" + args.type_factorization + ".txt", 'w')
        dictionary_lines = []
        ####################################################################################################################
    ...
    fingerprint_file = open("%s" % args.path + args.filenamePath + args.type_factorization + ".txt", 'w')

    fact_fingerprint_file = None
    if args.fact == 'create':
        # Create file containing factorizations
        fact_fingerprint_file = open("%s" % args.path + args.type_factorization + args.filenamePath  + ".txt", 'w')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dictionary_path', dest='dictionary_path', action='store', default='training/')
    parser.add_argument('--filenamePath', dest='filenamePath', action='store', default='Fingerprints/"+"fingerprint_')
    ...
    elif args.type == 'only_dataset':
        print('\nFingerprint Step: only_dataset...\n')
        fingerprint_only_on_dataset(args)